...
export default function Collections() {
    ...
    const midColl = useRef(null);
    const handleClick = () => {
        midColl.current?.scrollIntoView({
            behavior: "smooth"
        })
    }
    ...
    return <div className="relative flex flex-col items-center">
        ...
        <div className="absolute flex flex-col items-center text-center m-10 lg:p-48">
            <h1 className="text-3xl text-white lg:text-5xl mb-10 lg:mb-24 mt-2 outline-10 outline-black opacity-80">EVERY BOTTLE HAS A DRINKING WINDOW. OURS HAS A BUYING WINDOW.</h1>
        ...
        <div ref={midColl} className="lg:max-w-7xl flex flex-col items-start">
            <div className="flex">
